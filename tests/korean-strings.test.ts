...
const CONVERTED_SCREENS = [
  ...
  "apps/web/app/(shell)/progress/page.tsx",
  ...
  "apps/web/app/app/(shell)/settings/ai/ai-usage-settings.tsx",
  "apps/web/app/app/(shell)/settings/mcp/page.tsx",
  "apps/web/app/app/(shell)/settings/mcp/context-tools.tsx",
  "apps/web/app/app/(shell)/settings/mcp/token-manager.tsx",
  "apps/web/app/app/(shell)/settings/privacy/page.tsx",
  "apps/web/app/app/(shell)/settings/privacy/privacy-boundary.tsx",
  "apps/web/app/app/(shell)/stats/page.tsx",
  "apps/web/app/app/(shell)/stats/pilot-stats-dashboard.tsx",
