...
Full deterministic trial data: [./results.v3.smoke-preflight4.json](./results.v3.smoke-preflight4.json)

## Run contract

- Mode: `real`
- Schema version: `2`
- Generated: `2026-08-25T13:34:36.414Z`
...
| --- | ---: | ---: | --- | ---: | --- | --- | --- | --- | --- |
| all models (pooled) | 2 | 0.00pp | [0.00, 0.00] | -20.82% | [-22.85, -16.26] | yes | no | no | NOT MET |
| gpt-5.6-luna | 1 | 0.00pp | [0.00, 0.00] | -16.26% | [-16.26, -16.26] | yes | no | no | NOT MET |
| claude-sonnet-5 | 1 | 0.00pp | [0.00, 0.00] | -22.85% | [-22.85, -22.85] | yes | no | no | NOT MET |
...
| --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| all models (pooled) | checkout | 2 | 1.000 | [1.00, 1.00] | 100.00% | 4118 | 897 | 5015 | 18 | 11153 | 0 |
| all models (pooled) | full-dump | 2 | 0.500 | [0.00, 1.00] | 50.00% | 2531 | 2159 | 4690 | 0 | 25276 | 0 |
| all models (pooled) | data-brain | 2 | 1.000 | [1.00, 1.00] | 100.00% | 4848 | 1211 | 6059 | 20 | 14192 | 0 |
| gpt-5.6-luna | checkout | 1 | 1.000 | [1.00, 1.00] | 100.00% | 1337 | 207 | 1544 | 9 | 4735 | 0 |
| gpt-5.6-luna | full-dump | 1 | 0.000 | [0.00, 0.00] | 0.00% | 720 | 541 | 1261 | 0 | 9334 | 0 |
| gpt-5.6-luna | data-brain | 1 | 1.000 | [1.00, 1.00] | 100.00% | 1562 | 233 | 1795 | 10 | 3771 | 0 |
| claude-sonnet-5 | checkout | 1 | 1.000 | [1.00, 1.00] | 100.00% | 2781 | 690 | 3471 | 9 | 6418 | 0 |
| claude-sonnet-5 | full-dump | 1 | 1.000 | [1.00, 1.00] | 100.00% | 1811 | 1618 | 3429 | 0 | 15942 | 0 |
| claude-sonnet-5 | data-brain | 1 | 1.000 | [1.00, 1.00] | 100.00% | 3286 | 978 | 4264 | 10 | 10421 | 0 |

## Task × arm totals

| Task | Arm | Mean score | Total tokens | Tool calls | Wall ms | Failed |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| fixture-implement-remaining-session-ms | checkout | 1.000 | 5015 | 18 | 11153 | 0 |
| fixture-implement-remaining-session-ms | full-dump | 0.500 | 4690 | 0 | 25276 | 0 |
| fixture-implement-remaining-session-ms | data-brain | 1.000 | 6059 | 20 | 14192 | 0 |

## Every trial

| Task | Model | Arm | Trial | Status | Score | Input | Output | Total | Tools | Wall ms | Error |
| --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| fixture-implement-remaining-session-ms | gpt-5.6-luna | checkout | 1 | completed | 1.000 | 1337 | 207 | 1544 | 9 | 4735 |  |
| fixture-implement-remaining-session-ms | claude-sonnet-5 | checkout | 1 | completed | 1.000 | 2781 | 690 | 3471 | 9 | 6418 |  |
| fixture-implement-remaining-session-ms | gpt-5.6-luna | full-dump | 1 | completed | 0.000 | 720 | 541 | 1261 | 0 | 9334 |  |
| fixture-implement-remaining-session-ms | claude-sonnet-5 | full-dump | 1 | completed | 1.000 | 1811 | 1618 | 3429 | 0 | 15942 |  |
| fixture-implement-remaining-session-ms | gpt-5.6-luna | data-brain | 1 | completed | 1.000 | 1562 | 233 | 1795 | 10 | 3771 |  |
| fixture-implement-remaining-session-ms | claude-sonnet-5 | data-brain | 1 | completed | 1.000 | 3286 | 978 | 4264 | 10 | 10421 |  |
